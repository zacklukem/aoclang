...
#[no_mangle]
pub extern "C" fn _al_print_line(runtime: &Runtime, line: Value) -> Value {
    match line {
        Value::Str(line) => {
            println!("{}", *line);
        }
...
#[no_mangle]
pub extern "C" fn _al_assert(runtime: &Runtime, val: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_assert_eq(runtime: &Runtime, lhs: Value, rhs: Value) -> Value {
    if lhs != rhs {
...
#[no_mangle]
pub extern "C" fn _al_hash_code(_runtime: &Runtime, val: Value) -> Value {
...
// case Ref, Store, Load
#[no_mangle]
pub extern "C" fn _al_ref(_runtime: &Runtime, val: Value) -> Value {
    Value::Ref(Ref(Gc::new(val)))
}

#[no_mangle]
pub extern "C" fn _al_store(runtime: &Runtime, target: Value, val: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_load(runtime: &Runtime, source: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_eq(_runtime: &Runtime, a: Value, b: Value) -> Value {
    Value::Boolean(a == b)
}

#[no_mangle]
pub extern "C" fn _al_neq(_runtime: &Runtime, a: Value, b: Value) -> Value {
    Value::Boolean(a != b)
}
...
#[no_mangle]
pub extern "C" fn _al_lt(runtime: &Runtime, a: Value, b: Value) -> Value {
    comparison_op!(runtime, a, b, <)
}

#[no_mangle]
pub extern "C" fn _al_gt(runtime: &Runtime, a: Value, b: Value) -> Value {
    comparison_op!(runtime, a, b, >)
}

#[no_mangle]
pub extern "C" fn _al_le(runtime: &Runtime, a: Value, b: Value) -> Value {
    comparison_op!(runtime, a, b, <=)
}

#[no_mangle]
pub extern "C" fn _al_ge(runtime: &Runtime, a: Value, b: Value) -> Value {
    comparison_op!(runtime, a, b, >=)
}
...
#[no_mangle]
pub extern "C" fn _al_add(runtime: &Runtime, a: Value, b: Value) -> Value {
    math_op!(runtime, a, b, wrapping_add, add)
}

#[no_mangle]
pub extern "C" fn _al_sub(runtime: &Runtime, a: Value, b: Value) -> Value {
    math_op!(runtime, a, b, wrapping_sub, sub)
}

#[no_mangle]
pub extern "C" fn _al_mul(runtime: &Runtime, a: Value, b: Value) -> Value {
    math_op!(runtime, a, b, wrapping_mul, mul)
}

#[no_mangle]
pub extern "C" fn _al_div_int(runtime: &Runtime, a: Value, b: Value) -> Value {
    match (a, b) {
...
#[no_mangle]
pub extern "C" fn _al_div_float(runtime: &Runtime, a: Value, b: Value) -> Value {
    match (a, b) {
...
#[no_mangle]
pub extern "C" fn _al_mod(runtime: &Runtime, a: Value, b: Value) -> Value {
    math_op!(runtime, a, b, wrapping_rem, rem)
}

#[no_mangle]
pub extern "C" fn _al_pow(runtime: &Runtime, a: Value, b: Value) -> Value {
    match (a, b) {
...
#[no_mangle]
pub extern "C" fn _al_b_and(runtime: &Runtime, a: Value, b: Value) -> Value {
    bit_op!(runtime, a, b, bitand)
}

#[no_mangle]
pub extern "C" fn _al_b_or(runtime: &Runtime, a: Value, b: Value) -> Value {
    bit_op!(runtime, a, b, bitor)
}

#[no_mangle]
pub extern "C" fn _al_xor(runtime: &Runtime, a: Value, b: Value) -> Value {
    bit_op!(runtime, a, b, bitxor)
}

#[no_mangle]
pub extern "C" fn _al_shl(runtime: &Runtime, a: Value, b: Value) -> Value {
    match (a, b) {
...
#[no_mangle]
pub extern "C" fn _al_shr(runtime: &Runtime, a: Value, b: Value) -> Value {
    match (a, b) {
...
#[no_mangle]
pub extern "C" fn _al_concat(_runtime: &Runtime, a: Value, b: Value) -> Value {
    unimplemented!()
}

#[no_mangle]
pub extern "C" fn _al_not(_runtime: &Runtime, a: Value) -> Value {
    match a {
...
#[no_mangle]
pub extern "C" fn _al_list_new(_runtime: &Runtime, nargs: usize, args: *const Value) -> Value {
    let mut res = None;
...
#[no_mangle]
pub extern "C" fn _al_list_head(runtime: &Runtime, list: Value) -> Value {
    match list {
...
#[no_mangle]
pub extern "C" fn _al_list_tail(runtime: &Runtime, list: Value) -> Value {
    match list {
...
#[no_mangle]
pub extern "C" fn _al_list_is(_runtime: &Runtime, list: Value) -> Value {
    match list {
...
#[no_mangle]
pub extern "C" fn _al_list_is_empty(_runtime: &Runtime, list: Value) -> Value {
    return Value::Boolean(list == Value::List(None));
}

#[no_mangle]
pub extern "C" fn _al_list_to_tuple(runtime: &Runtime, list: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_list_cons(runtime: &Runtime, head: Value, tail: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_tuple_new(_runtime: &Runtime, nargs: usize, args: *const Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_tuple_get(runtime: &Runtime, tuple: Value, index: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_tuple_is(_runtime: &Runtime, tuple: Value) -> Value {
    match tuple {
...
#[no_mangle]
pub extern "C" fn _al_tuple_size(runtime: &Runtime, tuple: Value) -> Value {
    let Value::Tuple(tuple) = tuple else {
...
#[no_mangle]
pub extern "C" fn _al_string_chars(runtime: &Runtime, string: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_string_from_chars(runtime: &Runtime, mut chars: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_string_size(runtime: &Runtime, string: Value) -> Value {
    let Value::Str(string) = string else {
        throw(runtime, "Expected string");
    };
...
#[no_mangle]
pub extern "C" fn _al_string_split(runtime: &Runtime, string: Value, sep: Value) -> Value {
    unimplemented!();
}

#[no_mangle]
pub extern "C" fn _al_string_from_int(runtime: &Runtime, int: Value) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_int_is(_runtime: &Runtime, int: Value) -> Value {
    match int {
...
#[no_mangle]
pub extern "C" fn _al_int_from_string(runtime: &Runtime, string: Value) -> Value {
    let Value::Str(string) = string else {
        throw(runtime, "Expected string");
    };
...
// case FileReadString
#[no_mangle]
pub extern "C" fn _al_file_read_string(runtime: &Runtime, path: Value) -> Value {
...
// case ClosureNew
#[no_mangle]
pub extern "C" fn _al_closure_new(
    runtime: &Runtime,
    fn_ptr: FnPtr,
    nargs: usize,
    args: *const Value,
...
#[no_mangle]
pub extern "C" fn _al_closure_new_empty(_runtime: &Runtime, fn_ptr: FnPtr) -> Value {
    Value::Fn(fn_ptr)
}

#[no_mangle]
pub extern "C" fn _al_true_new(_runtime: &Runtime) -> Value {
    Value::Boolean(true)
}

#[no_mangle]
pub extern "C" fn _al_false_new(_runtime: &Runtime) -> Value {
    Value::Boolean(false)
}

#[no_mangle]
pub extern "C" fn _al_string_new(_runtime: &Runtime, val: *const c_char) -> Value {
    let val = unsafe { CStr::from_ptr(val).to_str().unwrap().to_owned() };
    Value::Str(Gc::new(val))
}

#[no_mangle]
pub extern "C" fn _al_int_new(_runtime: &Runtime, val: i64) -> Value {
    Value::Int(val)
}

#[no_mangle]
pub extern "C" fn _al_float_new(_runtime: &Runtime, val: f64) -> Value {
    Value::Float(HFloat(val))
}

#[no_mangle]
pub extern "C" fn _al_sym_new(runtime: &Runtime, val: *const c_char) -> Value {
...
#[no_mangle]
pub extern "C" fn _al_get_bool(runtime: &Runtime, val: Value) -> bool {
    match val {
        Value::Boolean(b) => b,
...
#[no_mangle]
pub extern "C" fn _al_raise(val: Value) -> bool {
    panic!("{}", val);
}

#[no_mangle]
pub extern "C" fn _al_runtime_new() -> *const Runtime {
...
#[no_mangle]
pub extern "C" fn _al_test_harness(rt: &Runtime, f: FnPtr, name: *const c_char) {
